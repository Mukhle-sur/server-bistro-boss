...
//3rd step: JWT-VERIFY function create
...
async function run() {
  try {
    ...
    app.get("/carts", verifyJWT, async (req, res) => {
      ...
      // verify login and access email same or not same?
...
app.listen(port, () => {
  console.log(`Bistro Boss always running is ${port}`);
});
